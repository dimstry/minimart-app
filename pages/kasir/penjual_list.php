...
$konten   = "
    ...
    <div class='d-sm-flex align-items-center justify-content-between mb-4'>
       <h3 class='mb-0 text-gray-800'><i class='fas  fa-shopping-bag'></i>    Penjualan List</h3>
        <div class='d-flex flex-row-reverse'>
        
        <a href='?page=kasir/penjual_tambah' class='d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mr-2'><i class='fas fa-plus'></i></a>
    </div>
    </div>
...
{
    case "tanya":
        $alert=towewengkonfirm("?page=kasir/penjual_hapus&id=$id&tgl=$tgl");
    break;
}
